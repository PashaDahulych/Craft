(() => {
    ...
    function formQuantity() {
        document.addEventListener("click", function(e) {
            ...
            if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
                const quantity = targetElement.closest("[data-quantity]");
                const valueElement = quantity.querySelector("[data-quantity-value]");
                let value = parseInt(valueElement.value);
                if (isNaN(value)) value = 0;
                if (targetElement.closest("[data-quantity-plus]")) {
                    value++;
                    if (+valueElement.dataset.quantityMax && value > +valueElement.dataset.quantityMax) value = +valueElement.dataset.quantityMax;
                } else {
                    value--;
                    if (+valueElement.dataset.quantityMin) {
                        if (value < +valueElement.dataset.quantityMin) value = +valueElement.dataset.quantityMin;
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".projects__slider", {
